...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<span class="navbar-brand mb-0 h1"> <img src="download.png"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item"><a class="nav-link"
				...
				<li class="nav-item"><a class="nav-link"
					href="http://localhost:8080/bibliotecaWebApp/login.jsp">Login </a></li>
				<li class="nav-item"><a class="nav-link"
					href="http://localhost:8080/bibliotecaWebApp/about.jsp">About</a></li>
			</ul>
		</div>
	</nav>
	...
	<form action="registrazione" method="post" enctype="multipart/form-data">
		...
		<div class="cliente">
			...
			<input type="file" class="btn btn-link btn-block" id="image" style="width: 150px; height: 45px; margin: auto" name="image" >
		</div><br>
